  ...
  return (  
    <>
      <main className="p-3 overflow-auto" style={{height: "85vh"}}>
          ...
          <nav aria-label="breadcrumb">
              <ol className="breadcrumb fs-6 ps-1">
                <li className="breadcrumb-item">
                    <Link 
                      to={params.type === 'user' ? "/" : params.type === 'generate section' ? '/section' : "/" + params.type}>
                        {params.type.substring(0, 1).toUpperCase() + params.type.substring(1)}
                    </Link>
                </li>
        ...
        { params.type === "generate section" ? <SectionInsertProfiles /> : "" } 
